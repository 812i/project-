...
if st.button("احسب أثرك البيئي الآن", type="primary"):
    ...
    st.write(f"استهلاكك السنوي من البلاستيك: تقريباً {plastic_yearly} قارورة.")
    st.write(f"ما يمكنك توفيره بالتدوير: تدوير هذه الكمية يمنع انبعاث نحو {co2_saved:.1f} كجم من ثاني أكسيد الكربون سنوياً.")
